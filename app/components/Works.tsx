...
const ProjectCard = ({
	...
	return (
		<motion.div variants={fadeIn("up", "spring", index * 0.2, 0.75)}>
			...
			{/* CARD */}
			<div className="bg-tertiary p-5 rounded-2xl sm:w-[360px] w-full hover:scale-[1.02] transition-transform">
	...
	return (
		<>
			...
			<div className="w-full flex">
				...
				>
					Real-world projects showcasing full-stack engineering, system design,
